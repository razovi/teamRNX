...
from bots.bot_portfolio import Portfolio
...
class TradingSimulator:
    ...
    def __init__(self, stock_symbols_list, trading_strategy, data_source_obj, trade_bots_num=None,
                 trade_bots_list=None):
        """
    ...
    def _generate_trade_bots(self, all_stock_symbols=True):
        for i in range(1, self.trade_bots_num + 1):
            if all_stock_symbols is True:
                trade_bot_i = PredictiveTradeBot(self.stock_symbols, i, 1000, 50, 10, 10, self.strategy,
